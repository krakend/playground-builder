...
export const resources = {
  docs: [
    { url: "https://www.krakend.io/docs/endpoints/rate-limit/", label: "Endpoint rate limit" },
    { url: "https://www.krakend.io/docs/backends/rate-limit/", label: "Backend rate limit" }
  ]
};
