...
This endpoint calls the same external API from CoinGecko that returns the cryptocurrency information you used in the [non-current option](/use-cases/market-concurrent).
...
Call it at least once to compare in the tracing dashboard the difference in load times vs the [non-concurrent option](/use-cases/market-simple)

[http://localhost:8080/market/simple](http://localhost:8080/market/concurrent)
